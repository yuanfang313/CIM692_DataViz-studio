...
async function drawBarChart() {
  //1_Access data
  const dataset = await d3.json("./worldoncover/th2_social issues.json")
  ...
  //3_Draw canvas
  const wrapper6 = d3.select("#wrapper6")
      .append("svg")
      .attr("width", dimensions.width)
      .attr("height", dimensions.height)
  const bounds = wrapper6.append("g")
...
const trendImage = d3.select("#trendImage6")
